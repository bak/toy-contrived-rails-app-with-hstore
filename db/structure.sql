...
--
-- Name: entries_gin_data; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX entries_gin_data ON entries USING gin (content);
...
INSERT INTO schema_migrations (version) VALUES ('20120403032849');

INSERT INTO schema_migrations (version) VALUES ('20120403033700');